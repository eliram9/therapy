        ...
        <>
            ...
            <section className='pt-10'>
                <PageContainer className='text-darkGray dark:bg-black pb-28'>
                    ...
                    <div className='flex md:flex-col-reverse md:flex-row items-center justify-between'>
                        ...
                        {/* Image Container */}
                        <div className='w-10/12 flex justify-end sm:justify-center sm:w-10/12 sm:py-5'>
